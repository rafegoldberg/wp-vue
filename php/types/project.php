...
function type_project() {
	...
	$labels = array(
		...
		'attributes'            => __( 'Project Details', 'text_domain' ),
		...
		'filter_items_list'     => __( 'Filter projects', 'text_domain' ),
	);
	$args = array(
		'label'                 => __( 'Project', 'text_domain' ),
		'description'           => __( 'Projects + experience', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'type_project', 0 );
?>